...
class CheckMajestic extends Command
{

    protected $signature = 'check-majestic';
    protected $description = 'Checks the Majestic metrics of some of the link sites';
    ...
    {
        $this->info('Starting to check Majestic metrics...');
        $this->checkNewSites();
    ...
    private function checkSites($numSellers, $max4thLowPrice, $minSRAS)
    {
        ...
        echo "Checking {$sites->count()} with {$numSellers} sellers, max 4th lowest: {$max4thLowPrice}\n";
    ...
    private function updateLinkSite($linkSite)
    {
